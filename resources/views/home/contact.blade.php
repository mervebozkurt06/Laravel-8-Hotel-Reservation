    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 mb-4 contact-left">
                ...
                <form name="sentMessage" id="contactForm" method="post" action="{{route('sendmessage')}}" novalidate>
                    @csrf
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Subject:</label>
                            <input type="text" name="subject" class="form-control" id="subject" required data-validation-required-message="Please enter your name.">
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div class="control-group form-group">
