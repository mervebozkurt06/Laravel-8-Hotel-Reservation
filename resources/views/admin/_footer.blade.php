    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                Copyright © 2018 Concept. All rights reserved. Dashboard by <a href="{{ asset('assets')}}/https://colorlib.com/wp/">Colorlib</a>.
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="text-md-right footer-links d-none d-sm-block">
                    <a href="{{ asset('assets')}}/javascript: void(0);">About</a>
                    <a href="{{ asset('assets')}}/javascript: void(0);">Support</a>
                    <a href="{{ asset('assets')}}/javascript: void(0);">Contact Us</a>
                </div>
            </div>
        </div>
    </div>
