            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin_image_store',['hotel_id'=>$data->id])}}" method="post" id="basicform" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <table id="example3" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example3_info">
                                            ...
                                            @foreach($images as $rs)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a href="{{route('admin_image_delete',['id'=>$rs->id,'hotel_id'=>$data->id])}}" onclick="return confirm('Record will be delete! Are you sure?')">
